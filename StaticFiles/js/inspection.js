...
export async function setup(node) {
	...
	try {
		...
		const data = await loadData(`https://localhost:7098/api/v1/inspection`, token)
  		console.log(data)
		
		displayData(data, node, 'Inspection', 'specificInspection')
...
async function addRecord() {
	...
	const uri = "https://localhost:7098/api/v1/inspection"
	const options = {
		method: "POST",
		headers: {
